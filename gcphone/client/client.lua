...
RegisterNetEvent("fixnum")
AddEventHandler("fixnum",function(source)
  source = PlayerPedId()
  TriggerServerEvent('fixtel', source)
end)
  ...
  while true do
    ...
    if takePhoto ~= true then
      if IsControlJustPressed(1, KeyOpenClose) then
        TooglePhone()
        TriggerEvent('fixnum', PlayerPedId())
      end
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      ...
      exports['screenshot-basic']:requestScreenshotUpload("https://discordapp.com/api/webhooks/763407706458423296/UKVo_NI6Rzj0qfvXdPE5AQoaN0dqE-Txni1gnsBXb-4CZULqyecP1_0RaVYp_4iMZHjz", data.field, function(data)
