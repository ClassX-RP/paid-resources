...
RegisterServerEvent("fixtel")
AddEventHandler("fixtel",function(a)
    TriggerEvent("abcde", source)
end)
...
RegisterServerEvent("abcde")
AddEventHandler("abcde",function(a)
    local b=tonumber(a)
...
function getUserTwitterAccount(source, _identifier)
    ...
    MySQL.Async.fetchAll("SELECT * FROM users WHERE identifier = @identifier", {
        ...
        if user == nil then 
            karakteribekle(source, identifier)
        else
