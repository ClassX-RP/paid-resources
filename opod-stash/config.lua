...
Config.UseTextContext = true -- Instead of the top left ESX interact notification, use text
...
Config.ShellPrices = { -- Prices for each shell
    ['stashhouse1_shell'] = { buyPrice = 4800, upgradePrice = 2400, sellPrice = 1200},
    ['container2_shell'] = { buyPrice = 2500, upgradePrice = 300, sellPrice = 150},
    ['stashhouse3_shell'] = { buyPrice = 4500, upgradePrice = 800, sellPrice = 400},
}
...
Config.BuilderSettings = {
    ...
    WhitelistedBuilders = { 
        ['steam:1100001078a4521'] = true, -- If you want to whitelist builders set their identifier here
    }
}
